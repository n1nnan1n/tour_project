...
const SuccessOrder = async (req, res) =>{
  const { order_id,user_id, tour_id, quantity, tour_date } = req.body;
  ...
  try {
    ...
    // Update the existing order status to "Success"
    await Order.updateOne(
      { _id:selectedOrder._id, user_id:selectedUser._id, tour_id:selectedTour._id, order_status: 'Waiting' },
...
module.exports = { orderCalculate,placeOrder,GetUserOrder,DeleteOrder,SuccessOrder };